...
**Contact:** KIR Research Computing Manager
...
| Model             | Path                                                         |
| ----------------- | ------------------------------------------------------------ |
| BERT base uncased | `/well/kir/mirror/LLM/huggingface/google-bert-berse-case-uncased` |
...
modules, and workflows that need adaptation. Please get in touch rather than
spending hours debugging architecture issues alone.

**KIR Research Computing Manager** — contact for:
...
Submit a ticket via the usual KIR support channel or come find us directly.