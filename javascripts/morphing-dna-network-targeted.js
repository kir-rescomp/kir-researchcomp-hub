// Morphing DNA Network Background - Page-Specific Version
(function() {
    'use strict';
    ...
    function shouldShowBackground() {
        ...
        // Check if current path matches any enabled page
        return ENABLED_PAGES.some(page => {
            // Exact match or ends with the page path
